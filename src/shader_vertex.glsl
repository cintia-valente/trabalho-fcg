...
out vec4 normal;
out vec2 texcoords;
out vec3 gouraud_color_vertex_shading;
...
void main()
{
    ...
    texcoords = texture_coefficients;
     ...
     if (gouraud_vertex_shading) {
        ...
        // Vetor para definir o sentido da câmera em relação ao ponto atual.
        vec4 v = normalize(position_camera - position_world);

        // Vetor para define o sentido da fonte de luz em relação ao ponto atual.
        vec4 l = v;
        ...
        gouraud_color_vertex_shading = lambert_diffuse_term + ambient_term + blinn_phong_specular_term; 
    }
}
